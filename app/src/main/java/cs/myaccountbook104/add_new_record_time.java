...
public class add_new_record_time extends Activity {

    private Intent intent;
    private Bundle bundle;
    Spinner account_type,account_type2;
    EditText number;
    DatePicker date;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_new_record_time);
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.confirm:
                    ...
                    String date = getdate();
                    db.execSQL("insert into main.tb_account_time(Accountbook_id,User_id,Account_name,Account_number,Account_time,Account_type) values (" + accountbookid + "," + userid + ",'" + account_name + "'," + numberofmoney + ",'" + date + "'," + account_type_to_int + ")");
            ...
            LocalBroadcastManager.getInstance(add_new_record_time.this).sendBroadcast(intent);
